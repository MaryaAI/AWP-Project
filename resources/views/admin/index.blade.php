        ...
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center text-right">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">عدد القطع</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $number_of_roadsters }}</div>
                    </div>
